...
const nodemodules = [
	...
	'Install Babel-Runtime', 'npm install babel-runtime --save-dev',
	'Install Babel-polyfill', 'npm install babel-polyfill --save-dev',
	'Install Babel-Preset-ENV', 'npm install babel-preset-env --save-dev',
	// install webpack
	'Install Webpack', 'npm install webpack@2.6.1 --save-dev',
	'Install Babel-loader', 'npm install babel-loader --save-dev',
	'Install Webpack-Dev-Server', 'npm install webpack-dev-server@2.11 --save-dev',
	// install mocha
